        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>About</h2>
              <p>Helper is dedicated to connecting clients with skilled professionals in various home service sectors. Our mission is to simplify the process of finding reliable experts for your home needs.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="{{asset('accueil/Helper/assets/img/team/taha.jpeg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="{{asset('accueil/Helper/assets/img/team/addy.jpg')}}" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Addy Willybrord ETOU-Elion</h4>
                <span>Marketing</span>
                <p>
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="{{asset('accueil/Helper/assets/img/team/oussama.jpeg')}}" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Oussama Ben Hammou
                </h4>
                <span>Content</span>
                <p>
    ...
    <section id="team" class="team pt-0">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="{{asset('accueil/Helper/assets/img/team/brahim.jpeg')}}" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Ibrahim
                  Jabrane
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="{{asset('accueil/Helper/assets/img/team/fahsi.jpg')}}" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Oussama El Fashi
                </h4>
                <span>Content</span>
