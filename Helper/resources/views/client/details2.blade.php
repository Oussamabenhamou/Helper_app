                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-3 card ">
							...
							<select class="form-select" id="subCategorySelect">
										<option value="Package delivery">Lawn mowing</option>
										<option value="Grocery delivery">Tree trimming</option>
										<option value="Furniture delivery">Garden cleanup</option>
										<option value="Courier delivery">Plant care</option>
									</select>
								</div>
								<!-- Price Slider -->
								<div class="card mb-3">
