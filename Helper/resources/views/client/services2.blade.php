                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="d-flex flex-wrap justify-content-center">
                                                <div class="card sub-service-card mx-2" onclick="selectSubService('Sub-Service 1')">
                                                    <div class="card-body text-center">
                                                        Lawn Mowing
                                                        <p>Professional lawn mowing service for a pristine yard.</p>
                                                    </div>
                                                </div>
                                                <div class="card sub-service-card mx-2" onclick="selectSubService('Sub-Service 2')">
                                                    <div class="card-body text-center">
                                                        Tree Trimming
                                                        <p>Expert tree trimming to maintain tree health and appearance.</p>
                                                    </div>
                                                </div>
                                                <div class="card sub-service-card mx-2" onclick="selectSubService('Sub-Service 3')">
                                                    <div class="card-body text-center">
                                                        Garden Cleanup
                                                        <p>Thorough garden cleanup for a tidy and vibrant outdoor space.</p>
                                                    </div>
                                                </div>
                                                <div class="card sub-service-card mx-2" onclick="selectSubService('Sub-Service 4')">
                                                    <div class="card-body text-center">
                                                        Plant Care
                                                        <p>Dedicated plant care to nurture and maintain your plants' health.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row mt-4" id="descriptionSection1" style="display: none;">
                                    <div class="col-md-12">
                                        <div class="service-container">
                                            <h2 class="sub-service-title">Description: Lawn Mowing</h2>
                                            <p class="text-center">Our professional lawn mowing service ensures your yard looks immaculate with precision cuts and attention to detail.</p>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="row mt-4" id="descriptionSection2" style="display: none;">
                                    <div class="col-md-12">
                                        <div class="service-container">
                                            <h2 class="sub-service-title">Description: Tree Trimming</h2>
                                            <p class="text-center">Experience expert tree trimming tailored to maintain the health, shape, and beauty of your trees.</p>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="row mt-4" id="descriptionSection3" style="display: none;">
                                    <div class="col-md-12">
                                        <div class="service-container">
                                            <h2 class="sub-service-title">Description: Garden Cleanup</h2>
                                            <p class="text-center">Transform your outdoor space with our comprehensive garden cleanup service, leaving it neat, tidy, and rejuvenated.</p>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="row mt-4" id="descriptionSection4" style="display: none;">
                                    <div class="col-md-12">
                                        <div class="service-container">
                                            <h2 class="sub-service-title">Description: Plant Care</h2>
                                            <p class="text-center">Trust our dedicated plant care specialists to nurture your plants, ensuring they thrive and flourish in their environment.</p>
                                        </div>
                                    </div>
                                </div>
